<h1>3887 - Minimum Cost Path with Edge Reversals</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/minimum-cost-path-with-edge-reversals/">minimum-cost-path-with-edge-reversals</a></h2><p>You are given a directed, weighted graph with <code>n</code> nodes labeled from 0 to <code>n - 1</code>, and an array <code>edges</code> where <code>edges[i] = [u<sub>i</sub>, v<sub>i</sub>, w<sub>i</sub>]</code> represents a directed edge from node <code>u<sub>i</sub></code> to node <code>v<sub>i</sub></code> with cost <code>w<sub>i</sub></code>.</p>
