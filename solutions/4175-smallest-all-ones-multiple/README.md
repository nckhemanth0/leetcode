<h1>4175 - Smallest All-Ones Multiple</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/smallest-all-ones-multiple/">smallest-all-ones-multiple</a></h2><p>You are given a positive integer <code>k</code>.</p>
