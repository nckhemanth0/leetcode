<h1>4226 - Check Digitorial Permutation</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/check-digitorial-permutation/">check-digitorial-permutation</a></h2><p>You are given an integer <code>n</code>.</p>
