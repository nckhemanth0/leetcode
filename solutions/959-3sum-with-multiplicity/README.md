<h1>959 - 3Sum With Multiplicity</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/3sum-with-multiplicity/">3sum-with-multiplicity</a></h2><p>Given an integer array <code>arr</code>, and an integer <code>target</code>, return the number of tuples <code>i, j, k</code> such that <code>i &lt; j &lt; k</code> and <code>arr[i] + arr[j] + arr[k] == target</code>.</p>
