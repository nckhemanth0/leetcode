<h1>339 - Nested List Weight Sum</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/nested-list-weight-sum/">nested-list-weight-sum</a></h2><p>You are given a nested list of integers <code>nestedList</code>. Each element is either an integer or a list whose elements may also be integers or other lists.</p>
