<h1>4065 - Count Sequences to K</h1><h2>Difficulty: Hard - <a href="https://leetcode.com/problems/count-sequences-to-k/">count-sequences-to-k</a></h2><p>You are given an integer array <code>nums</code>, and an integer <code>k</code>.</p>
