<h1>3250 - Maximum Square Area by Removing Fences From a Field</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/maximum-square-area-by-removing-fences-from-a-field/">maximum-square-area-by-removing-fences-from-a-field</a></h2><p>There is a large <code>(m - 1) x (n - 1)</code> rectangular field with corners at <code>(1, 1)</code> and <code>(m, n)</code> containing some horizontal and vertical fences given in arrays <code>hFences</code> and <code>vFences</code> respectively.</p>
