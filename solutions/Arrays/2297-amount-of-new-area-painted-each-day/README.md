<h1>2297 - Amount of New Area Painted Each Day</h1><h2>Difficulty: Hard - <a href="https://leetcode.com/problems/amount-of-new-area-painted-each-day/">amount-of-new-area-painted-each-day</a></h2><p>There is a long and thin painting that can be represented by a number line. You are given a <strong>0-indexed</strong> 2D integer array <code>paint</code> of length <code>n</code>, where <code>paint[i] = [start<sub>i</sub>, end<sub>i</sub>]</code>. This means that on the <code>i<sup>th</sup></code> day you need to paint the area <strong>between</strong> <code>start<sub>i</sub></code> and <code>end<sub>i</sub></code>.</p>
