<h1>4024 - Minimum Cost to Split into Ones</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/minimum-cost-to-split-into-ones/">minimum-cost-to-split-into-ones</a></h2><p>You are given an integer <code>n</code>.</p>
