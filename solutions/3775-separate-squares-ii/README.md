<h1>3775 - Separate Squares II</h1><h2>Difficulty: Hard - <a href="https://leetcode.com/problems/separate-squares-ii/">separate-squares-ii</a></h2><p>You are given a 2D integer array <code>squares</code>. Each <code>squares[i] = [x<sub>i</sub>, y<sub>i</sub>, l<sub>i</sub>]</code> represents the coordinates of the bottom-left point and the side length of a square parallel to the x-axis.</p>
