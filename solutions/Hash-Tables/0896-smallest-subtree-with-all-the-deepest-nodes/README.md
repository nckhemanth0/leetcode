<h1>896 - Smallest Subtree with all the Deepest Nodes</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/smallest-subtree-with-all-the-deepest-nodes/">smallest-subtree-with-all-the-deepest-nodes</a></h2><p>Given the <code>root</code> of a binary tree, the depth of each node is <strong>the shortest distance to the root</strong>.</p>
